describe "Tails.Mixins.Interceptable", ->
  ...
  describe ".extended", ->
    ...
    it "should include Tails.Mixins.DynamicProperties", ->
      class Model extends Backbone.Model
        _.extend(@, Tails.Mixable)

      spy = sinon.spy(Model, 'include')
      Model.extend(Tails.Mixins.Interceptable)
      expect(spy).to.have.been.calledWith(Tails.Mixins.DynamicProperties)
