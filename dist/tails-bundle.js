...
(function() {
  ...
  Tails.Association = (function(_super) {
  ...
  Tails.Mixins.Associations = {
    ClassMethods: {
      belongsTo: function(options) {
        var association, attribute, target;
        attribute = _(options).keys()[0];
        target = options[attribute];
        association = new Tails.Associations.BelongsToAssociation({
          owner: this,
          attribute: attribute,
      ...
      hasOne: function(options) {
        ...
        attribute = _(options).keys()[0];
        target = options[attribute];
        association = new Tails.Associations.HasOneAssociation({
          owner: this,
          attribute: attribute,
          foreignKey: options.foreignKey,
      ...
      hasMany: function(options) {
        ...
        attribute = _(options).keys()[0];
        target = options[attribute];
        association = new Tails.Associations.HasManyAssociation({
          owner: this,
          attribute: attribute,
          foreignKey: options.foreignKey,
          through: options.through,
      ...
      associations: function() {
        return Tails.Association.all().where({
          owner: this
        });
      },
      extended: function() {
        ...
        return this.before({
          initialize: function() {
            Tails.Associations.BelongsToAssociation.all().where({
            ...
            Tails.Associations.HasOneAssociation.all().where({
              owner: this.constructor
            }).each((function(_this) {
              return function(association) {
                return association.apply(_this);
            ...
            return Tails.Associations.HasManyAssociation.all().where({
              owner: this.constructor
            }).each((function(_this) {
              return function(association) {
                return association.apply(_this);
  ...
  Tails.Model = (function(_super) {
    ...
    Model.concern(Tails.Mixins.Associations);
...
//# sourceMappingURL=tails-bundle.js.map